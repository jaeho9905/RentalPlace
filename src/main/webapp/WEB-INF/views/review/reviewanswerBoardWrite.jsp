...
<link rel="stylesheet"
	href="/resources/css/board/sub3/qna_edit_page.css">
...
<body>
					...
					<div class="content">
						<div class="doc">
							<div class="wrapper-bbs">
								...
								<!-- 테이블 -->
								<div class="table-wrap">
									<form action="/review/reviewanswerBoardWrite" method="post"
										onsubmit="return false;">
										<input type="hidden" name="review_no"
											value="${review.review_no}"> <input type="hidden"
											name="a_writer_name" value="관리자"> <input
											...
											<tbody>
												<tr>
													...
													<td colspan="3"><input type="text"
														...
														placeholder="제목을 작성해 주세요" name="answer_title" id="title"
														maxlength="50" value="re:${enquiry.enquiry_title}"
														autocomplete="off"></td>
												</tr>
												<tr>
												...
												<tr>
													<td colspan="4" style="padding: 8px 0px;"><textarea
															id="popContent" name="reviewanswer_content"></textarea></td>
												</tr>
											</tbody>
										...
										<!-- 글쓰기 btn -->
										<div class="write">
											<input type="submit" class="write_btn" value="답변하기"
	...
	$(function() {
		...
		CKEDITOR.replace('popContent' , {
			 filebrowserImageUploadUrl: "/upload?boardName=reviewanswer",
			 height: 500                                                  
	     });
